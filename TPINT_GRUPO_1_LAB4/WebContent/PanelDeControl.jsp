...
<body> 
	...
	<table class="table table-hover table-dark" style="margin-top: 150px;"> 
	  <thead>
	    <tr>
	...
	<a href="HistorialMovimientos.jsp"><button  type="button" class="btn btn-link">Ver todos mis movimientos</button></a>
	
	<h2 style="margin-top:100px;">Prestamos</h2>
	<button href="#"type="button" class="btn btn-outline-info">Manejar mis prestamos</button>
